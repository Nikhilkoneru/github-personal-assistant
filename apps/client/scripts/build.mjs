...
const externalRuntimeFiles = [
  ...
  'https://esm.sh/codemirror@6.0.2?target=es2022',
  'https://esm.sh/@codemirror/state@6.6.0?target=es2022',
  'https://esm.sh/@codemirror/view@6.40.0?target=es2022',
  'https://esm.sh/@codemirror/lang-markdown@6.5.0?target=es2022',
